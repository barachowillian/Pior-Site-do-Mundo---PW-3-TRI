...
![Código do Index:](img/Indeximagem.png) <br>
...
## Funcionalidades
- Menu inicial com botões e plano de fundo animado.  
- Página de cadastro com mensagens de alerta ao enviar os dados.  
- Interações básicas desenvolvidas com JavaScript.  
- Layout propositalmente desajustado e colorido.
...
## Observação  
As imagens e referências visuais utilizadas pertencem ao universo **Winx Club**, de propriedade da **Rainbow S.p.A.**, e foram usadas apenas para fins educacionais e sem fins lucrativos.
